    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table => { table.PrimaryKey("PK_BankAccounts", x => x.BankAccountId); });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table => { table.PrimaryKey("PK_CreditCards", x => x.CreditCardId); });
...
ADD CONSTRAINT CK_CreditCardId_BankAccountId CHECK ((CreditCardId IS NULL AND BankAccountId IS NOT NULL) OR (CreditCardId IS NOT NULL AND BankAccountId IS NULL))");
        }
